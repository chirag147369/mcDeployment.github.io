...
<div class="row">
  <div class="col-12 mb-50">
    <button class="btn btn-primary ml-1" appRippleEffect>
      <i appDataFeather="plus" class="mr-0 mr-sm-1"></i
      ><span class="d-none d-sm-inline-block">Add New Record</span>
    </button>

    <a csvLink [data]="exportCSVData" class="btn btn-outline-secondary float-right mr-1" appRippleEffect
      >Export CSV</a
    >
  </div>
      ...
      <div class="d-flex align-items-center">
        <div ngbDropdown container="body">
          <a
            ...
            aria-expanded="false"
          >
            <i appDataFeather="more-vertical" class="text-primary cursor-pointer mr-50"></i>
          </a>
          <div ngbDropdownMenu class="dropdown-menu-right" aria-labelledby="dropdownBrowserState">
            <a href="javascript:void(0)" ngbDropdownItem class="d-flex align-items-center"
              ><i appDataFeather="file-text" class="mr-50"></i> Details</a
            >
            <a href="javascript:void(0)" ngbDropdownItem class="d-flex align-items-center"
              ><i appDataFeather="archive" class="mr-50"></i> Archive</a
            >
            <a href="javascript:void(0)" ngbDropdownItem class="d-flex align-items-center"
              ><i appDataFeather="trash-2" class="mr-50"></i> Delete</a
            >
          </div>
        </div>

        <i appDataFeather="edit" class="text-primary cursor-pointer"></i>
      </div>
    </ng-template>
  </ngx-datatable-column>
</ngx-datatable>
