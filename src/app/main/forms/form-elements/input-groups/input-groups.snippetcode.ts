...
export const snippetCodeBasic: SnippetCode = {
  ...
  <div class="input-group mb-2">
    <div class="input-group-prepend">
      <span class="input-group-text" id="basic-addon-search1"><i appDataFeather="search"></i></span>
    </div>
    <input
      type="text"
      class="form-control"
...
export const snippetCodeMerged: SnippetCode = {
  ...
  <div class="input-group input-group-merge mb-2">
    <div class="input-group-prepend">
      <span class="input-group-text" id="basic-addon-search2"><i appDataFeather="search"></i></span>
    </div>
    <input
      type="text"
      class="form-control"
    ...
    <div class="col-md-6 col-12 mb-1">
      <div class="input-group">
        ...
        <div class="input-group-append" id="button-addon2">
          <button class="btn btn-outline-primary" type="button" appRippleEffect>Go</button>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-12 mb-1">
      <div class="input-group">
        <div class="input-group-prepend">
          <button class="btn btn-outline-primary" type="button" appRippleEffect>
            <i appDataFeather="search"></i>
          </button>
        </div>
        <input type="text" class="form-control" placeholder="Button on both side" aria-label="Amount" />
        <div class="input-group-append">
          <button class="btn btn-outline-primary" type="button" appRippleEffect>Search !</button>
        </div>
      </div>
    </div>
  </div>
