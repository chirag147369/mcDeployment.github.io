      ...
      <div class="input-group">
        ...
        <div class="input-group-append">
          <button class="btn btn-outline-secondary feather icon-calendar" (click)="basicDP.toggle()"
            type="button" appRippleEffect></button>
        </div>
      </div>
    </div>
  </form>
...
export const snippetCodeDisabledDP: SnippetCode = {
  ...
  <button class="btn btn-sm btn-outline-{{disabled ? 'danger' : 'success'}} my-1" (click)="disabled = !disabled" appRippleEffect>
...
export const snippetCodeCustomFooterDP: SnippetCode = {
  ...
  <ng-template #footerTemplate>
    ...
    <button class="btn btn-primary btn-sm m-2 float-left"
      (click)="customFooterDPdata = today; customFooterDP.close()" appRippleEffect>Today</button>
    <button class="btn btn-secondary btn-sm m-2 float-right" (click)="customFooterDP.close()" appRippleEffect>Close</button>
  </ng-template>
  <!--/ Custom Footer Date Picker -->
  `,
  ts: `
...
export const snippetCodeCustomTP: SnippetCode = {
  ...
  <button class="btn btn-sm btn-outline-{{customTPseconds ? 'success' : 'danger'}}"
    (click)="customTPtoggleSeconds()" appRippleEffect>
...
export const snippetCodeSpinnerTP: SnippetCode = {
  ...
  <button class="m-t-1 btn btn-sm btn-outline-{{spinnerTP ? 'success' : 'danger'}}" (click)="snipperTPtoggle()" appRippleEffect>
