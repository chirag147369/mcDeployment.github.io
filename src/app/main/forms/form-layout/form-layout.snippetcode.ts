...
<form class="form form-horizontal">
  <div class="row">
    ...
    <div class="col-sm-9 offset-sm-3">
      <button type="submit" appRippleEffect class="btn btn-primary mr-1">Submit</button>
      <button type="reset" appRippleEffect class="btn btn-outline-secondary">Reset</button>
    </div>
  </div>
</form>
  `
        ...
        <div class="col-sm-9">
          <div class="input-group input-group-merge">
            <div class="input-group-prepend">
              <span class="input-group-text"><span [appDataFeather]="'user'"></span></span>
            </div>
            <input
              type="text"
              id="fname-icon"
    ...
    <div class="col-12">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <div class="input-group input-group-merge">
            <div class="input-group-prepend">
              <span class="input-group-text"><span [appDataFeather]="'mail'"></span></span>
            </div>
            <input
              type="email"
              id="email-icon"
    ...
    <div class="col-12">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <div class="input-group input-group-merge">
            <div class="input-group-prepend">
              <span class="input-group-text"><span [appDataFeather]="'smartphone'"></span></span>
            </div>
            <input
              type="number"
              id="contact-icon"
    ...
    <div class="col-12">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <div class="input-group input-group-merge">
            <div class="input-group-prepend">
              <span class="input-group-text"><span [appDataFeather]="'lock'"></span></span>
            </div>
            <input
              type="password"
              id="pass-icon"
