  ...
  <div *ngFor="let item of items; let i = index" @heightIn>
    <div class="row d-flex align-items-end">
      <div class="col-md-4 col-12">
        <div class="form-group">
          ...
          <input
            ...
            name="itemName{{ i }}"
            id="itemName{{ i }}"
            placeholder="App Admin Template"
          />
        </div>
      </div>
      ...
      <div class="col-md-2 col-12 mb-50">
        <div class="form-group">
          <button class="btn btn-outline-danger text-nowrap px-1" (click)="deleteItem(i)" appRippleEffect>
            <i appDataFeather="x" class="mr-25"></i>
            <span>Delete</span>
          </button>
        </div>
      </div>
...
<div class="row">
  <div class="col-12">
    <button class="btn btn-icon btn-primary" type="button" (click)="addItem()" appRippleEffect>
      <i appDataFeather="plus" class="mr-25"></i>
      <span>Add New</span>
    </button>
  </div>
</div>
