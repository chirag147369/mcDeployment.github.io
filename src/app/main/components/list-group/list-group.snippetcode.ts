...
export const snippetCodeIcons: SnippetCode = {
  ...
  <li class="list-group-item d-flex">
    <p class="float-left mb-0">
      <span [appDataFeather]="'instagram'" [size]="16" [class]="'mr-1'"></span>
    </p>
    <span>Cupcake sesame snaps dessert marzipan.</span>
  </li>
  <li class="list-group-item d-flex">
    <p class="float-left mb-0">
      <span [appDataFeather]="'facebook'" [size]="16" [class]="'mr-1'"></span>
    </p>
    <span>Jelly beans jelly-o gummi bears chupa chups marshmallow.</span>
  </li>
  <li class="list-group-item d-flex">
    <p class="float-left mb-0">
      <span [appDataFeather]="'twitter'" [size]="16" [class]="'mr-1'"></span>
    </p>
