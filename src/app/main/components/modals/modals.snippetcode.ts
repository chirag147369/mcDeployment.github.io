...
export const snippetCodeBasicModal: SnippetCode = {
  ...
  <button type="button" (click)="modalOpen(modalBasic)" class="btn btn-outline-primary" appRippleEffect>
    Basic Modal
  </button>
  ...
  <ng-template #modalBasic let-modal>
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-primary" (click)="modal.close('Accept click')" appRippleEffect>
        Accept
      </button>
    </div>
  </ng-template>
  ...
  <!-- Button trigger modal -->
  <button type="button" class="btn btn-outline-primary" (click)="modalOpenVC(modalVC)" appRippleEffect>
    Vertically Centered
  </button>
  ...
  <!-- Button trigger modal -->
  <button type="button" class="btn btn-outline-primary" (click)="modalOpenBD(modalBD)" appRippleEffect>
    Disabled Backdrop
  </button>
  ...
  <!-- Button trigger modal -->
  <button type="button" class="btn btn-outline-primary" (click)="modalOpenAD(modalAD)" appRippleEffect>
    Disabled Animation
  </button>
...
<div class="modal-secondary d-inline-block">
  ...
  <button
    type="button"
    class="btn btn-outline-secondary appRippleEffect"
...
<div class="modal-success d-inline-block">
  ...
  <ng-template #modalSuccess let-modal>
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-success" (click)="modal.close('Accept click')" appRippleEffect>
        Accept
      </button>
    </div>
  </ng-template>
...
<div class="modal-danger d-inline-block">
  ...
  <ng-template #modalDanger let-modal>
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-danger" (click)="modal.close('Accept click')" appRippleEffect>
        Accept
      </button>
    </div>
  </ng-template>
...
<div class="modal-warning d-inline-block">
  ...
  <ng-template #modalWarning let-modal>
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-warning" (click)="modal.close('Accept click')" appRippleEffect>
        Accept
      </button>
    </div>
  </ng-template>
...
<div class="modal-info d-inline-block">
  <!-- Button trigger modal -->
  <button type="button" class="btn btn-outline-info" (click)="modalOpenInfo(modalInfo)" appRippleEffect>
    Info
  </button>
  ...
  <ng-template #modalInfo let-modal>
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-info" (click)="modal.close('Accept click')" appRippleEffect>
        Accept
      </button>
    </div>
  </ng-template>
...
<div class="modal-dark d-inline-block">
  <!-- Button trigger modal -->
  <button type="button" class="btn btn-outline-dark" (click)="modalOpenDark(modalDark)" appRippleEffect>
    Dark
  </button>
  ...
  <ng-template #modalDark let-modal>
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-dark" (click)="modal.close('Accept click')" appRippleEffect>
        Accept
      </button>
    </div>
  </ng-template>
...
export const snippetCodeEvent: SnippetCode = {
  ...
  <!-- Button trigger modal -->
  <button type="button" (click)="modalOpenOSE(modalOSE)" class="btn btn-outline-primary" appRippleEffect>
    On Show Event
  </button>
...
<div class="modal-before-dismiss-event">
  <!-- Button trigger modal -->
  <button type="button" (click)="modalOpenBDE(modalBDE)" class="btn btn-outline-primary" appRippleEffect>
...
export const snippetCodeFormScrollingComponents: SnippetCode = {
  ...
  <!-- Button trigger modal -->
  <button type="button" (click)="modalOpenForm(modalForm)" class="btn btn-outline-primary" appRippleEffect>
    Login Form
  </button>
...
<div class="scrolling-long-content">
  <!-- Button trigger modal -->
  <button type="button" (click)="modalOpenSLC(modalSLC)" class="btn btn-outline-primary" appRippleEffect>
