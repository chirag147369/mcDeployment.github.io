...
export const snippetCodeAdvance: SnippetCode = {
  ...
  <div class="mt-1">
    <button class="btn btn-primary" (click)="zoomIn()" appRippleEffect>Zoom in</button>
    <button class="btn btn-primary ml-1" (click)="zoomOut()" appRippleEffect>Zoom out</button>
  </div>
  <!--/ Google Maps Advance Component -->
  `,
  ts: `
